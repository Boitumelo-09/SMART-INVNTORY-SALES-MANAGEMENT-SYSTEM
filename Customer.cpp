...
Customer::Customer(int customerID, const std::string& customerName, const std::string& customerEmail, const std::string& deliveryAddress)
    : customerID(customerID), customerName(customerName), customerEmail(customerEmail), deliveryAddress(deliveryAddress) {
}
